...
#        )
        FIND_LIBRARY(OPENCL_LIBRARIES "/opt/AMDAPPSDK-3.0/lib/x86_64")
        ...
        # to the library
        FIND_PATH(OPENCL_INCLUDE_DIRS CL/cl.h PATHS ${_OPENCL_INC_CAND} "/usr/local/cuda/include" "/opt/AMDAPP/include" "/opt/AMDAPPSDK-3.0/include" ENV OpenCL_INCPATH)
        FIND_PATH(_OPENCL_CPP_INCLUDE_DIRS CL/cl.hpp PATHS ${_OPENCL_INC_CAND} "/usr/local/cuda/include" "/opt/AMDAPP/include" "/opt/AMDAPPSDK-3.0/include" ENV OpenCL_INCPATH)

        set(OPENCL_INCLUDE_DIR  "/opt/AMDAPPSDK-3.0/include")
#        MESSAGE(STATUS "Opencl libraries: ${OPENCL_LIBRARIES}")
        link_directories("/opt/AMDAPPSDK-3.0/lib/x86_64/")
